      ...
      <el-card class="table-card">
        ...
        <div class="pagination-wrap">
          <el-pagination v-model:current-page="page" v-model:page-size="pageSize" :total="total"
            layout="total, prev, pager, next" @change="fetchCompanies" />
        </div>
      </el-card>

      <!-- Create/Edit Dialog -->
      <el-dialog v-model="dialogVisible" :title="isEdit ? 'កែប្រែក្រុមហ៑ុន' : 'បន្ថែមក្រុមហ៑ុន'" width="600px"
        destroy-on-close>
        <el-form :model="form" :rules="rules" ref="formRef" label-position="top">

          <p class="section-label">Basic info</p>
          <el-form-item label="ឈ្មោះ" prop="name">
            <el-input v-model.trim="form.name" size="large" />
          </el-form-item>

          <el-divider />
          <p class="section-label">Location</p>
          <el-form-item label="Map Link" prop="map_link">
            <el-input v-model.trim="form.map_link" size="large"></el-input>
          </el-form-item>
          <div class="form-row">
          ...
          <div class="form-row">
            ...
            <el-form-item label="អាចស្កែនក្រៅតំបន់បាន" prop="can_scan_outsize">
              ...
              <el-radio-group v-model="form.can_scan_outsize">
                <el-radio :value="1" size="large">អាចស្កែនបាន</el-radio>
                <el-radio :value="0">មិនអាចស្កែនបាន</el-radio>
              </el-radio-group>
          ...
          <el-divider />
          <div class="form-row">
            <el-form-item label="រូបិយប័ណ្ណ" prop="currency">
        ...
        <el-radio value="USD" size="large" border>USD</el-radio>
        <el-radio value="KHR" size="large" border>KHR</el-radio>
      </el-radio-group>
  ...
  const rules = {
    ...
    left_early_penalty: [{required: true,message: 'Left Early Penalty required'}],
    can_scan_outsize: [{required: true,message: 'Employee Can scan outsize or not'}]
  }
